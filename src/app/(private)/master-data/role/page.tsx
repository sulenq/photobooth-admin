...
import { ROLE_BASE_ENDPOINT } from "@/shared/constants/apiEndpoints";
import { DUMMY_ROLES } from "@/shared/constants/dummyData";
import {
...
type DataInterface = Role;

const BASE_ENDPOINT = ROLE_BASE_ENDPOINT;
const PREFIX_ID = `roles`;
